...
<template>
<section id="gallery" class="flex flex-col items-center justify-center py-24 " data-aos="fade-up">
...
<div class="flex py-32">
  ...
  <div class="image-container overflow-hidden flex duration-200 " data-aos="fade-right" data-aos-duration="1500">
    <nuxt-img
      :src="currentImage"
